                            ...
                            <ul class="nav-main">
                                ...
                                <li class="open">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a class="active" href="be_ui_tabs.html">Tabs</a>
                                        </li>
                                        <li>
                    ...
                    <div class="row">
                                    ...
                                    <li class="nav-item ml-auto">
                                        <div class="btn-group btn-group-sm mr-15">
                                            ...
                                            <div class="btn-group btn-group-sm" role="group">
                                                <button type="button" class="btn btn-secondary" id="btnGroupTabs1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="block">
                                <ul class="nav nav-tabs nav-tabs-block  justify-content-end align-items-center" data-toggle="tabs" role="tablist">
                                    <li class="nav-item mr-auto">
                                        <div class="btn-group btn-group-sm ml-15">
                                            <button type="button" class="btn btn-secondary">
                                                <i class="fa fa-undo"></i>
                                            </button>
                                            <button type="button" class="btn btn-secondary">
                                            ...
                                            <div class="btn-group btn-group-sm" role="group">
                                                <button type="button" class="btn btn-secondary" id="btnGroupTabs2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="fa fa-angle-down"></i>
                                                </button>
                                                <div class="dropdown-menu" aria-labelledby="btnGroupTabs2">
                                                    <a class="dropdown-item" href="javascript:void(0)">
                                                        <i class="fa fa-fw fa-bell mr-5"></i>News
                                                    </a>
                                                    <a class="dropdown-item" href="javascript:void(0)">
