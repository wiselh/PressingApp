        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="block-content">
                        ...
                        @foreach($categories as $categorie)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-alt-primary" style="padding: 0 8px"
                                            data-toggle="modal" data-target="#modal-fromright"
                                            data-name="{{$categorie->categorie_name}}"
                                        ...
                                        <form action="/categories/{{$categorie->id_categorie}}" method="post">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-alt-danger"
                                                    style="padding: 0 8px" data-toggle="tooltip" title="Delete">
                    ...
                    <!-- From Right Modal -->
                    <div class="modal fade" id="modal-fromright" tabindex="-1" role="dialog"
                         aria-labelledby="modal-fromright" aria-hidden="true">
                                ...
                                <form class="edit-categorie-form" method="post" action="/categories">
                                    ...
                                    <div class="block block-themed block-transparent mb-0">
                                        ...
                                        <div class="block-content">
                                            <div class="form-group col-md-12">
                                                <div class="row">
                                                    <label class="col-md-6 col-sm-12 col-form-label"
                                                           for="categorie_name">Nom du Categorie <span
                                                                class="text-danger">*</span></label>
                                                    <div class="col-md-6 col-sm-12 ">
                                                        <input type="text" class="form-control" id="categorie_name"
                                                               name="categorie_name" required
                                                               placeholder="Enter le nom du categorie..">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-12">
