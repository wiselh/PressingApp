                                        ...
                                        <div class="col-md-12 col-md-offset-6">
                                                <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                                <label class="col-lg-4 col-form-label" for="client_name">Nom du Client <span class="text-danger">*</span></label>
                                                                <div class="col-lg-8">
                                                                        <input type="text" class="form-control" id="client_name" name="client_name" placeholder="Enter a username..">
                                                                </div>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                                <label class="col-lg-4 col-form-label" for="client_name">Telephone du Client</label>
                                                                <div class="col-lg-6">
                                                                        <input type="text" class="form-control" id="client_name" name="client_name" placeholder="212-999-0000">
                                                                </div>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                                <label class="col-lg-4 col-form-label" for="client_adresse">Adresse du Client </label>
                                                                <div class="col-lg-8">
                                                ...
                                                <div class="row" id="vetements">
                                                        ...
                                                        <div class="row col-md-12" id="myvet" >
                                                                                ...
                                                                                <div class="form-group col-md-2 col-lg-2 col-sm-12">
                                                                                        ...
                                                                                        <div class="col-lg-12">
                                                                                                <input type="text" class="form-control vetement_quantity" id="vetement_quantity" name="vetement_quantity[]" value="1"  placeholder="Entrer la quantity">
                                                                                        </div>
                                                                                        <input type="hidden" class="total_price" name="price[]">
                                                                                </div>
                                                        </div>
...
@section('page_script')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                //calcul total price
                $('#vetement_quantity,#vetement_price').keyup(function () {
