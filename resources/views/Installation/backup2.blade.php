                                    ...
                                    <div class="js-wizard-validation-material block">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-alt nav-fill" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" href="#wizard-validation-material-step1"
                                                   data-toggle="tab">1. Utilisateur Informations</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#wizard-validation-material-step2"
                                                   data-toggle="tab">2. Societe Informations</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#wizard-validation-material-step3"
                                                   data-toggle="tab">3. Autre Informations</a>
                                            </li>
                                        </ul>
                                        <!-- END Step Tabs -->
                                        <!-- Form -->
                                        ...
                                        <!-- Steps Content -->
                                            <div class="block-content block-content-full tab-content" style="min-height: 267px;">
                                                <!-- Step 1 -->
                                                <div class="tab-pane active row" id="wizard-validation-material-step1" role="tabpanel">
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="user_name">Photo de Profile <span style="font-size: 11px;">(optionnel)</span></label>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-material floating">
                                                                <input class="form-control" type="text" id="user_name"
                                                                       name="user_name">
                                                                <label for="user_name">Nom Complete <span
                                                ...
                                                <div class="tab-pane" id="wizard-validation-material-step2" role="tabpanel">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group" style="margin-top: 5px">
                                                            <div class="row">
                                                                <label class="col-md-6 col-sm-12">Logo de
                                                                    Societe</label>
                                                                <div class="col-md-6 col-sm-12">
                                                                    <label class="custom-file pull-right"
                                                                           style="position: unset;">
                                                                        <input class="custom-file-input "
                                                                               id="societe_logo" name="societe_logo"
                                                                               type="file">
                                                                        <span class="custom-file-control" id="logo_name"
                                                ...
                                                <!-- Step 3 -->
                                                <div class="tab-pane row" id="wizard-validation-material-step3" role="tabpanel">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="form-material floating">
                                                                <textarea class="form-control" id="societe_description"
                                                                          ...
                                                                          rows="4"></textarea>
                                                                <label for="societe_description">Description <span
                                                                            style="font-size: 11px;">(optionnel)</span></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="block-content block-content-sm block-content-full bg-body-light">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 text-right">
                                                        <button type="button" class="btn btn-alt-secondary" id="test"
                                                                data-wizard="next">
